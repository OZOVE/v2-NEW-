...
export default function Section1() {
  ...
  return (
    <div className="lg:relative lg:h-[385px] lg:mt-20 flex flex-col lg:flex-row">
      <div className="lg:w-full w-full h-[40vh] lg:h-[385px]">
        <Map />
      </div>
      <div className="lg:absolute lg:top-0 lg:left-0 lg:w-[400px] lg:h-[380px] w-full h-full bg-gray-50">
