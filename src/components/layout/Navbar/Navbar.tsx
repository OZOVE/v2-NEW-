  ...
  return (
    <nav className="bg-graish text-white z-50 font-medium fixed top-0 w-full ">
      <div className="flex items-center justify-between w-full lg:px-14 px-4">
        ...
        <ul className="md:flex hidden font-semibold items-center justify-end  gap-4">
          <li>
          ...
          <div>
            <Link
              href={"/contact"}
              className="py-2 px-3 w-[80px] text-center inline-block border border-white rounded-lg text-white"
            >
              Login
            </Link>
          </div>
          <Link
            href={"/contact"}
            className="py-2 w-[80px] inline-block bg-white text-black rounded-lg text-center"
          >
            Sign Up
          </Link>
        </ul>
